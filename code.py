...
Invoice Number (Ensure it is extracted in plain text without .).
...
Description (Extract the product or service description, it should display product description, contract and month details, if it matches with IFRS17
 United Fidelity Insurance UAE
 Contract SHMA IFRS 1706062022-04 eff
07/01/22 36 months 01/10/2024 -
31/12/2024 extract that also).
Quantity (Qty) (Ensure it is extracted as a number).
Unit Price (Extract only the numeric value).
Net Amount (Extract only the numeric value).
